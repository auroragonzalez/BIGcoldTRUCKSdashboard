...
htmltools::h5("GitHub seasonality file:")
shiny::actionButton("do", "Click Me")

shiny::observeEvent(input$do, {
# shiny::reactive(input$do, {
  ...
  # github_credentials <- git2r::cred_user_pass("auroragonzalez", "mypassword")
...
############### SI QUIERES ESCRIBIR LA TABLA EN FORMATO ANCHO (1 FILA/PRODUCTO Y 1 COLUMNA/FECHA) REFLEJANDOSE LA SELECCION
  data2 <- {descargaExp()}
###############
  write.table(data2, paste0(path,'/seasonality.csv'))
  ...
  # hay que evitar usar las user pass pero no lo he conseguido así todavía:
  # git2r::push(repo, credentials = git2r::cred_ssh_key())
